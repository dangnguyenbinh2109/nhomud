...
const TeacherDashboard = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Sinh đề thi trắc nghiệm, bài tập từ ngân hàng câu hỏi hoặc với sự hỗ trợ của AI.',
      link: '/teacher/create-exam',
    },
    {
      icon: <ScanLine size={24} />,
      title: 'Chấm bài bằng OCR',
      description: 'Quét, số hóa và chấm điểm tự động bài kiểm tra trắc nghiệm của học sinh.',
      link: '/teacher/ocr-grading',
    },
    {
      icon: <FolderKanban size={24} />,
      title: 'Quản lý Tài nguyên',
      description: 'Lưu trữ và tổ chức tài liệu, ngân hàng câu hỏi, và các kế hoạch giảng dạy cá nhân.',
